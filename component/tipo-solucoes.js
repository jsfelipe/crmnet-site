                ...
                <div className="row tipo-solucoes">
                        ...
                        <div className="col-md-4 d-flex mb-mob" data-aos="fade-up" data-aos-duration="400">
                            <div className="content-inner text-white shadow rounded p-4 text-center">
                                ...
                                <p>
                                Com a utilização de um CRM na sua indústria, será possível compreender melhor o Workflow, conseguir gerar orçamentos e entender mais da cadência de pedidos, analisando a recorrência e o fluxo de ações automatizadas. O CRMNet também faz integrações com sistemas ERPs (Enterprise Resource Planning), como o Bling e o Conta Azul.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4 d-flex" data-aos="fade-up" data-aos-duration="1000">
                            <div className="content-inner text-white shadow rounded p-4 text-center">
                                ...
                                <p>
                                O CRMNet integrado aos serviços será utilizado no atendimento e suporte a venda, compreendendo sobre as necessidades/problemas das leads. Além disso, com a aplicação do CRM, ficará mais acessível ao histórico e informações, facilitando o fluxo de trabalho e otimizando a produtividade da sua equipe.
                                </p>
                            </div>
                        </div>
                </div>
