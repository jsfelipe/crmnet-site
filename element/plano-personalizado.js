				...
				<div className="row action-box align-items-center shadow rounded box-meu-plano">
					<div className="col-xl-8 col-lg-8 col-md-8 p-5">
						<div className="center-mob">
							...
							<Link href="https://api.whatsapp.com/send?phone=5581999446929" target="_blank"><a className="btn btn-info btn-round" data-aos="fade-up" data-aos-duration="400">Negociar um plano</a></Link>
						</div>
					</div>
