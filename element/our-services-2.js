				...
				<div className="row align-items-center">
					...
					<div className="icon-bx-wraper style-3 left m-r100 m-b30 d-flex" data-aos="fade-up" data-aos-duration="300">
							...
							<div className="">
								...
								<p>O CRM.Net iniciou sua história com o desafio de dois jovens empreendedores e desenvolvedores em 5 de dezembro de 2010, para desenvolvimento de um CRM para uma empresa de grande cadeia em Pernambuco. Porém, em 2012, aproximadamente, graças à procura de um amigo por um CRM gratuito que conseguisse automatizar ações e levasse uma maior qualidade de vida e diminuição de tempo, eles decidiram levar a ferramenta para frente, visto que, o software tinha um potencial de crescimento. Com isso, aliados a esse amigo que é um experiente profissional de administração e consultoria, decidiram fundar o CRM.Net em Recife - Pernambuco.</p>
							</div>
						</div>
						...
						<div className="icon-bx-wraper style-3 left m-r100 m-b30 d-flex" data-aos="fade-up" data-aos-duration="700">
							...
							<div className="">
								...
								<p>Somos uma empresa SaaS (Software como Serviço), permitindo aos usuários se conectar e usar aplicativos baseados em nuvem pela Internet. Aqui no CRM.Net, utilizamos toda a tecnologia da Amazon para manter nossos serviços.</p>
							</div>
						</div>
					</div>
				</div>
