...
function crmParaFranquias() {
  return (
    <>
     ...
     <Head>
    <title>CRM para Agências | CRMNet</title>
    </Head>
      <Header />
        ...
        <section className="solucoes">
            ...
            <div className="container">
                ...
                <div className="row align-items-center flex-row-reverse mb-mob center-mob">
                    ...
                    <p>Entenda mais sobre indicadores e métricas importantes para sua agência. Com a aplicação da CRMNet, haverá recursos que auxiliam na tomada de decisões e análise de desempenho, todos analisados em tempo real e com segurança. </p>
                    </div>
                </div>
