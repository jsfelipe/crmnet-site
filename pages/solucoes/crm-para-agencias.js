...
function crmParaFranquias() {
  return (
    <>
     ...
     <Head>
    <title>CRM para Agências | B2 CRM</title>
    </Head>
      <Header />
        ...
        <section className="solucoes">
            ...
            <div className="container">
                ...
                <div className="row align-items-center pt-5 mb-mob center-mob">
                    ...
                    <p>Com a B2 CRM, as integrações estarão disponíveis para facilitar pagamentos, cadastro de oportunidades e auxiliar suas estratégias de marketing digital.</p>
                    </div>
                </div>
                <div className="row align-items-center flex-row-reverse mb-mob center-mob">
                    ...
                    <p>Entenda mais sobre indicadores e métricas importantes para sua agência. Com a aplicação da B2 CRM, haverá recursos que auxiliam na tomada de decisões e análise de desempenho, todos analisados em tempo real e com segurança. </p>
                    </div>
                </div>
