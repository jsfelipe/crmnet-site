...
function crmParaImobiliaria() {
  return (
    <>
     <Head>
    <title>CRM para Imobiliárias | CRMNet</title>
    </Head>
      <Header />
        ...
        <section className="solucoes">
            ...
            <div className="container">
                ...
                <div className="row align-items-center pt-5 mb-mob center-mob">
                    ...
                    <p>As automações presentes na CRMNet facilitam o dia a dia das imobiliárias, principalmente, no que diz respeito a automação de envio de e-mails, de marketing e otimização no processo de vendas.   </p>
                    </div>
                </div>
                ...
                <div className="row align-items-center mb-mob center-mob">
                    ...
                    <p>O modelo estratégico de divisão do funil de vendas, utilizado da CRMNet, ajudará sua empresa a selecionar as etapas de atração, conversão, relacionamento, vendas e pós-venda dos clientes.</p>
                    </div>
                </div>
                <div className="row align-items-center flex-row-reverse mb-mob center-mob pb-5">
                    ...
                    <p>Conheça sua persona, seus problemas/necessidades, os canais mais utilizados e quais devem ser seus objetivos para chegar da melhor maneira nelas. Com a CRMNet, sua persona será facilmente definida e analisada, melhorando as estratégias para conquistá-la.</p>
                    </div>
                </div>
            </div>
