...
function crmParaPme() {
  return (
    <>
     <Head>
    <title>CRM para Pequenas e Médias Empresas | CRMNet</title>
    </Head>
      <Header />
        ...
        <section className="solucoes">
            ...
            <div className="container">
                ...
                <div className="row align-items-center pt-5 mb-mob center-mob">
                    ...
                    <p> Com a utilização de históricos, disponíveis na CRMNet, sua empresa conseguirá ter acesso detalhado das atividades realizadas, como alterações, entrada de novas leads ou envio de e-mails em determinado horário e data.</p>
                    </div>
                </div>
