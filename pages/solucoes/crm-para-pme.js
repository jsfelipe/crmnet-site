...
function crmParaPme() {
  return (
    <>
     <Head>
    <title>CRM para Pequenas e Médias Empresas | CRM.Net</title>
    </Head>
      <Header />
        ...
        <section className="solucoes">
            ...
            <div className="container">
                ...
                <div className="row align-items-center pt-5 mb-mob center-mob">
                    ...
                    <p> Com a utilização de históricos, disponíveis na CRM.Net, sua empresa conseguirá ter acesso detalhado das atividades realizadas, como alterações, entrada de novas leads ou envio de e-mails em determinado horário e data.</p>
                    </div>
                </div>
                <div className="row align-items-center flex-row-reverse mb-mob center-mob">
                    ...
                    <p>Com a integração de gatilhos inteligentes, disponível no CRM.Net, será possível o envio das leads que entram em critério definido pelo usuário e disparadas em fluxo.</p>
                    </div>
                </div>
                ...
                <div className="row align-items-center flex-row-reverse  mb-mob center-mob pb-5">
                    ...
                    <p>A Experiência do Cliente é tratada como métrica essencial para acompanhar a Jornada do Cliente, oferecendo sempre a melhor forma de atender e solucionar problemas. Com o CRM.Net, sua CX irá alavancar e engajar clientes, possibilitando a melhora no atendimento e o recebimento do feedback.</p>
                    </div>
                </div>
            </div>
