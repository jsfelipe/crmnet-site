                ...
                <div className="row align-items-center shadow banner-inner rounded pos-top m-mob p-4">
                  ...
                  <div className="col-lg-4 col-sm-4 fadeInUp">
                    ...
                    <ul className="pricingtable-features">
                      ...
                      <li className="center-mob mb-mob"><Link href="https://api.whatsapp.com/send?phone=5581992971917"><a className="btn btn-primary border-0 mt-3" target="_blank" data-aos="fade-up" data-aos-duration="400">consultar plano</a></Link></li>
										</ul>
                  </div>
                </div>
              </div>
