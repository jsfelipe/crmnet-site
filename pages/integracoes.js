...
function Integracoes() {
  ...
  return (
    <>
    <Head>
    <title>Integrações | CRMNet</title>
    </Head>
              ...
              <div className="container">
                <div className="row align-items-center shadow banner-inner rounded pos-top m-mob">
                  <div className="col-lg-7 col-sm-7 pl-5 fadeInUp">
                    ...
                    <p className="mb-0">As diversas integrações nativas do CRM permitem que você utilize o CRMNet como um Hub de leads . Você centraliza suas leads vindas de todas as fontes de tráfego e distribui elas para sua equipe de vendas, atendimento ou administrativa. 
