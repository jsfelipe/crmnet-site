        ...
        <div className="container">
          <div className="row align-items-center shadow p-4 banner-inner rounded pos-top m-mob">
            <div className="col-lg-7 col-sm-7">
              ...
              <p className="mb-0">Inspirado nas pontes de Recife que unem os diversos bairros da cidade, unem o velho e o novo, o moderno e o antigo. Somos o CRMNet. Somos as pontes e conexões que unem os diversos canais de aquisição e gestão de leads.</p>
            </div>
