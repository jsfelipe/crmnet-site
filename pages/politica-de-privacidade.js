              ...
              <div className="container">
                ...
                <div className="row pb-5">
                    <div className="col-lg-12 col-sm-12 p-5">
                        ...
                        <p>Leia com atenção os termos que regem nossa relação. Antes de usar a B2 CRM é importante que você leia e concorde com nossa política. Ao efetuar seu cadastro para utilização dos serviços, você concorda com nossa política, sem modificações.</p>
