              ...
              <div className="row">
                <MenuRecursos/>
                      ...
                      <div className="row align-items-center mb-mob">
                        ...
                        <p className="center-mob">Na CRM.Net você recebe os leads advindos de diversos canais na central de vendas e atendimento integrado com o CRM. Tudo em um único lugar. </p>
                        </div>
                      </div>
                      ...
                      <div className="row align-items-center flex-row-reverse mb-mob">
                        ...
                        <div className="col-md-7">
                        <h4 className="center-mob">Envie SMS e faça ligações diretamente do <br/>CRM.Net a partir da integração com parceiros</h4>
                        <p>Com a CRM.Net você pode enviar SMS e realizar ligações diretamente do sistema.
                        Para isso, é necessário integrar o CRM.Net com parceiros de VOIP.</p>
                      ...
                      <div className="row align-items-center mb-5 mb-mob">
                        ...
                        <div className="col-md-7">
                          <h4 className="center-mob">Mande e-mails diretamente da CRM.Net</h4>
                          <p>Na CRM.Net, você pode enviar e-mails diretamente da sua oportunidade. Ao enviar e-mails, os remetentes serão os usuários que estão cadastrados no sistema, com o e-mail de login.“E-mail”. Simples e rápido!.Você ainda pode usar os templates.</p>
                        </div>
                      </div>
                      ...
                      <div className="row p-3 mb-5 integ_whats rounded shadow align-items-center m-mob">
                        ...
                        <h4 className="center-mob">Integração CRM.Net e WhatsApp</h4>
                        <p>Com a CRM.Net você pode transformar o WhatsApp em uma verdadeira máquina de vendas para a sua empresa. Concentre todos os atendimentos do aplicativo em um só lugar, totalmente integrado. </p>
                      ...
                      <div className="container mb-0 mb-mob">
                        ...
                        {/* <Tab eventKey="LeadChat" title="LeadChat" >
                          ...
                          <div className="row align-items-center">
                            ...
                            <p>O CRM.Net conta com o suporte da integração com o Instagram, na qual são geradas mais oportunidades de negócios a partir do Direct do aplicativo. </p>
                            </div>
                          </div>
                          </Tab>
                          ...
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-8">
                            <p>Integre a CRM.Net ao Facebook Messenger e sincronize as mensagens que chegam no Facebook Messenger com a Central de Mensagens do CRM.Net e atualize seu funil dentro do CRM.Net</p>
                          ...
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-8 col-sm-12 p-mob">
                              <p>Integrando a CRM.Net ao JivoChat ou a outros onde você recebe os leads gerados nesta plataforma no CRM.Net, os quais são armazenados como oportunidades. Tenha todo o volume de leads e histórico de conversas no painel do nosso CRM.</p>
                              <p>Além dessas canais de comunicação, o CRM.Net conta também com o suporte de várias outras integrações que facilitam a comunicação no seu negócio, como chats diversos, a exemplo do Tawk.to, e de alternativas de voz, como o Vtcall, Zenvia e Phonetrack.</p>
