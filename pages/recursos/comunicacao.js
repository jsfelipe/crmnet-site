              ...
              <div className="row">
                <MenuRecursos/>
                      ...
                      <div className="row align-items-center mb-mob">
                        ...
                        <p className="center-mob">Na B2 CRM você recebe os leads advindos de diversos canais na central de vendas e atendimento integrado com o nosso CRM, você tem tudo em um único lugar. </p>
                        </div>
                      </div>
                      ...
                      <div className="row align-items-center flex-row-reverse mb-mob">
                        ...
                        <div className="col-md-7">
                        <h4 className="center-mob">Envie SMS e faça ligações diretamente do <br/>B2 CRM a partir da integração com parceiros</h4>
                        <p>Com a B2 CRM você pode enviar SMS e realizar ligações diretamente do sistema.
                        Para isso, é necessário integrar a B2 CRM com a solução VOIP da B2, saiba mais da PBX b2.</p>
                      ...
                      <div className="row align-items-center mb-5 mb-mob">
                        ...
                        <div className="col-md-7">
                          <h4 className="center-mob">Mande e-mails diretamente da B2 CRM</h4>
                          <p>Na B2 CRM, você pode enviar e-mails diretamente da sua oportunidade. Ao enviar e-mails, os remetentes serão os usuários que estão cadastrados no sistema, com o e-mail de login.“E-mail”. Simples e rápido!.Você ainda pode usar os templates.</p>
                        </div>
                      </div>
                      ...
                      <div className="row p-3 mb-5 integ_whats rounded shadow align-items-center m-mob">
                        ...
                        <h4 className="center-mob">Integração B2 CRM e WhatsApp</h4>
                        <p>Com a B2 CRM você pode transformar o WhatsApp em uma verdadeira máquina de vendas para a sua empresa. Concentre todos os atendimentos do aplicativo em um só lugar, totalmente integrado. </p>
                      ...
                      <div className="container mb-0 mb-mob">
                        ...
                        {/* <Tab eventKey="LeadChat" title="LeadChat" >
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-8">
                            <p>Capte mais leads com este conjunto de ferramentas poderoso e fácil de usar. Além do Chatbot e LeadChat, você pode engajar seus leads inbound com os Formulários Web. LeadChat (um novo acelarador de leads) pode ser adquirido com qualquer plano do B2 CRM </p>
                            </div>
                          </div>
                          </Tab> */}
                          ...
                          <div className="row align-items-center">
                            ...
                            <p>O B2 CRM conta com o suporte da integração com o Instagram, na qual são geradas mais oportunidades de negócios a partir do Direct do aplicativo. </p>
                            </div>
                          </div>
                          </Tab>
                          ...
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-8">
                            <p>Integre a B2 CRM ao Facebook Messenger e sincronize as mensagens que chegam no Facebook Messenger com a Central de Mensagens da B2 CRM e atualize seu funil dentro do CRM.Net</p>
                          ...
                          <div className="row align-items-center">
                            ...
                            <div className="col-md-8 col-sm-12 p-mob">
                              <p>Integrando a B2 B2 CRM ao JivoChat ou a outros onde você recebe os leads gerados nesta plataforma no B2 CRM, os quais são armazenados como oportunidades. Tenha todo o volume de leads e histórico de conversas no painel do nosso CRM.</p>
                              <p>Além dessas canais de comunicação, o B2 CRM conta também com o suporte de várias outras integrações que facilitam a comunicação no seu negócio, como chats diversos, a exemplo do Tawk.to, e de alternativas de voz, como o Vtcall, Zenvia e Phonetrack.</p>
