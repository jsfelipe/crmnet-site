              ...
              <div className="row">
                <MenuRecursos/>
                      ...
                      <div className="row align-items-center mb-mob">
                        ...
                        <p className="center-mob">Na CRMNet você recebe os leads advindos de diversos canais na central de vendas e atendimento integrado com o CRM. Tudo em um único lugar. </p>
                        </div>
                      </div>
                      ...
                      <div className="row align-items-center mb-5 mb-mob">
                        ...
                        <div className="col-md-7">
                          <h4 className="center-mob">Mande e-mails diretamente da CRMNet</h4>
                          <p>Na CRMNet, você pode enviar e-mails diretamente da sua oportunidade. Ao enviar e-mails, os remetentes serão os usuários que estão cadastrados no sistema, com o e-mail de login.“E-mail”. Simples e rápido!.Você ainda pode usar os templates.</p>
                        </div>
                      </div>
                      ...
                      <div className="container mb-0 mb-mob">
                        ...
                        {/* <Tab eventKey="LeadChat" title="LeadChat" >
                          ...
                          <div className="row align-items-center">
                            ...
                            <p>O CRMNet conta com o suporte da integração com o Instagram, na qual são geradas mais oportunidades de negócios a partir do Direct do aplicativo. </p>
                            </div>
                          </div>
                          </Tab>
