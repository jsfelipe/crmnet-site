              ...
              <div className="row">
                ...
                <div className="row align-items-center center-mob mb-mob mob-center">
                    ...
                    <div className="row col-lg-7 col-md-12">
                      <h2>Gráficos</h2>
                      <p>Com a CRM.Net, tenha acesso à gráficos sobre a performance do seu negócio e exporte todas as informações, caso achar necessário. Acompanhe sempre o desempenho da sua empresa.</p>
                      <p>Na CRM.Net, você pode visualizar gráficos de metas, sobre clientes e oportunidades e, desse modo, ficar por dentro da performance da sua empresa. Diante disso, você tem em mãos informações valiosas para tomar decisões mais estratégicas no seu negócio.</p>
                    </div>
                </div>
