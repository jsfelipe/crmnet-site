                    ...
                    <div className="row align-items-center center-mob mb-mob">
                      ...
                      <div className="row col-lg-7 col-sm-7">
                        <h4>Crie e gerencie as suas atividades</h4>
                          ...
                          <p>Além disso, você pode ser lembrado pelo CRMNet das atividades a partir do recebimento de notificação por e-mail.</p>
                      </div>
                    </div>
                    ...
                    <div className="row align-items-center pb-5 flex-row-reverse center-mob mb-mob">
                      ...
                      <div className="row col-lg-7 col-sm-7">
                        <h4>Adicione lembretes as suas atividades</h4>
                          <p>No CRMNet você tem acesso a todas as atividades cadastradas, sejam elas relacionadas ou não à alguma oportunidade. Além disso, você pode configurar para receber lembretes dessas atividades cadastradas e, assim, não esquecer dos compromissos.</p>
