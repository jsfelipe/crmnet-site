...
function Atendimento() {
  return (
    <>
     <Head>
    <title>Atendimento | B2 CRM</title>
    </Head>
      <Header />
            ...
            <div className="container">
              ...
              <div className="row">
                ...
                <div className="row align-items-center center-mob">
                    ...
                    <div className="row col-lg-7 col-sm-7">
                      ...
                      <p>No mundo dos negócios, o atendimento ao público é peça-chave para o progresso de qualquer empresa. Diante disso, com o B2 CRM você exerce maior controle sobre as suas negociações e, assim, sempre estará por dentro do que foi tratado pela última vez com os clientes.</p>
              ...
              <div className="row align-items-center flex-row-reverse center-mob">
                ...
                <div className="row col-lg-7 col-sm-7">
                  ...
                  <p>Com a B2 CRM todos os atendimentos realizados por você ou por sua equipe de vendas ficam centralizados em um único só lugar. Desse modo, o histórico de conversas, com o dia, hora e o tipo de atendimento, fica registrado e acessível para você e o seu time ficar sempre por dentro do que foi conversado anteriormente.</p>
