...
function Oportunidades() {
  return (
    <>
     <Head>
    <title>Controle de Oportunidades e Negócios | CRMNet</title>
    </Head>
      <Header />
            ...
            <div className="content-inner-2 mt-3">
              <div className="container">
                ...
                <div className="row mt-5">
                  ...
                  <p>O CRMNet tem como filosofia facilitar a vida dos usuários, não é a toa que chamam ele do Iphone dos CRMS e, para isso, dispõe de recursos que facilitam a sua vida.
