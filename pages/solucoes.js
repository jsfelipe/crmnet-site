        ...
        <div className="dlab-bnr-inr style-2">
          <div className="container">
            <div className="dlab-bnr-inr-entry">
              <h1>Soluções</h1>
              <h5>A B2 CRM oferece as melhores soluções alinhadas a tecnologia,<br/> estratégias e desenvolvimento para diversos nichos</h5>
            </div>
          </div>
        </div>
        {/* <!-- Banner End --> */}
            ...
            <div className="container">
                <div className="row align-items-center mt-4">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>Contratar um CRM (Customer Relationship Management ou Gestão de relacionamento com o cliente) que se adapta com o modelo do negócio de cada segmento traz uma série de benefícios impressionantes. Veja alguns deles:</p>
                      <p>Personalização e flexibilidade: Cada negócio possui processos e requisitos específicos. A B2 CRM se adapta ao modelo do seu negócio permite personalizar e configurar o sistema de acordo com as necessidades exclusivas da sua empresa. Você pode ajustar campos, fluxos de trabalho, automações e relatórios para refletir as operações e os objetivos do seu negócio. Essa flexibilidade permite que você crie um CRM sob medida para atender as demandas específicas do seu setor.</p>
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>Para melhorar a gestão da sua empresa de energia solar, a B2 CRM oferece condições para gerenciamento de propostas, administração da sua equipe de engenharia, integração com o marketing e acompanhamento do funil de vendas.</p>
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>No gerenciamento de processos de vendas ou manutenção da carteira, o CRM se torna imprescindível para uma empresa de seguros. A B2 CRM, é o mais simples de usar e completo do mercado, concentra e gerencia todas as informações em um único software, além de aumentar sua taxa de conversão e disponibilizar relatórios gerenciais. </p>
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>Na gestão de pagamentos, enriquecimento de dados dos clientes e geração de boletos através de integrações, a B2 CRM é o CRM adequado para sua empresa de cobrança.</p>
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>Um CRM voltado para o agronegócio, como a B2 CRM, estará disponível para um acompanhamento maior baseado em históricos e segmentação de possíveis clientes, separando por localização, produtos e propriedades.</p>
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>Com a B2 CRM, haverá a possibilidade de gerir sua leads em potencial vindo de diversas fontes de tráfego, identificar novas oportunidades, comandar processos seletivos, indicar turma/curso de interesse, registrar todas as atividades, realizar matrícula através da plataforma e mapear propensões dos pais e estudantes. A facilidade de comunicação e o controle sobre a evasão preditiva também será alcançado com o CRM.</p>
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>A B2 CRM também aumenta o destaque da sua marca em um mercado extremamente concorrido, aumenta sua produtividade, acompanha o engajamento das leads de seus clientes, além de conseguir reter os clientes atuais e organizar seu planejamento, avaliando o ROI e ROAS de suas campanhas.</p>
                      <a href="/solucoes/crm-para-agencias" className="btn btn-info shadow btn-round center-mob" data-wow-delay="2s">Saiba mais</a>
                    </div>
                </div>
                <div className="row align-items-center">
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>O Clinic é um spinoff da B2 CRM, estará diretamente focado no CRM especializado para clínicas odontológicas, médicas e de estética. Com a plataforma será possível deixar de lado processos manuais e confusos, adotando prontuários eletrônicos.</p>
                ...
                <div className="row align-items-center pb-4">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>O CRM poderá ser acessado através de dispositivos móveis, por meio de aplicativos. A B2 CRM é o melhor CRM para imobiliárias e seus clientes!</p>
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>A maneira mais inteligente para vender infoprodutos todos os dias pela internet, é utilizando a B2 CRM Com um CRM especializado, o “ponto de ativação com seu cliente” é criado e problemas de “Como fazer isso do jeito certo?” serão sanados. O CRM.Net fará isso por você e auxiliará a aumentar as conversões de seus infoprodutos.</p>
                ...
                <div className="row align-items-center mb-5">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>A B2 CRM é uma ótima opção para integrar a sua franquia. Com o CRM acessível, sua franquia conseguirá ter landing pages eficientes, possuir relatórios completos e atualizados, além de compreender o seu tráfego, definir sua persona e aplicar um funil de vendas.</p>
