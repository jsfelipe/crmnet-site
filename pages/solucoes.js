        ...
        <div className="dlab-bnr-inr style-2">
          <div className="container">
            <div className="dlab-bnr-inr-entry">
              <h1>Soluções</h1>
              <h5>O CRM.Net oferece as melhores soluções alinhadas a tecnologia,<br/> estratégias e desenvolvimento para diversos nichos</h5>
            </div>
          </div>
        </div>
        {/* <!-- Banner End --> */}
            ...
            <div className="container">
                <div className="row align-items-center mt-4">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>Aplicando o White Label na sua empresa, com a ajuda do CRM.Net Pro, será possível ofertar o produto de desenvolvimento, visando o planejamento do conteúdo disponibilizado pela sua marca.</p>
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>Para melhorar a gestão da sua empresa de energia solar, o CRM.Net oferece condições para gerenciamento de propostas, administração da sua equipe de engenharia, integração com o marketing e acompanhamento do funil de vendas.</p>
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>No gerenciamento de processos de vendas ou manutenção da carteira, o CRM se torna imprescindível para uma empresa de seguros. O CRM.Net, o CRM mais simples de usar e completo do mercado, concentra e gerencia todas as informações em um único software, além de aumentar sua taxa de conversão e disponibilizar relatórios gerenciais. </p>
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>Na gestão de pagamentos, enriquecimento de dados dos clientes e geração de boletos através de integrações, o CRM.Net é o CRM adequado para sua empresa de cobrança.</p>
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>Um CRM voltado para o agronegócio, como o CRM.Net, estará disponível para um acompanhamento maior baseado em históricos e segmentação de possíveis clientes, separando por localização, produtos e propriedades.</p>
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>Com o CRM.Net, haverá a possibilidade de gerir sua leads em potencial vindo de diversas fontes de tráfego, identificar novas oportunidades, comandar processos seletivos, indicar turma/curso de interesse, registrar todas as atividades, realizar matrícula através da plataforma e mapear propensões dos pais e estudantes. A facilidade de comunicação e o controle sobre a evasão preditiva também será alcançado com o CRM.</p>
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>O CRM.Net também aumenta o destaque da sua marca em um mercado extremamente concorrido, aumenta sua produtividade, acompanha o engajamento das leads de seus clientes, além de conseguir reter os clientes atuais e organizar seu planejamento, avaliando o ROI e ROAS de suas campanhas.</p>
                      <a href="/solucoes/crm-para-agencias" className="btn btn-info shadow btn-round center-mob" data-wow-delay="2s">Saiba mais</a>
                    </div>
                </div>
                <div className="row align-items-center">
                ...
                <div className="row align-items-center flex-row-reverse">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>O Clinic é um spinoff do CRM.Net, estará diretamente focado no CRM especializado para clínicas odontológicas, médicas e de estética. Com a plataforma será possível deixar de lado processos manuais e confusos, adotando prontuários eletrônicos.</p>
                ...
                <div className="row align-items-center pb-4">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>O CRM poderá ser acessado através de dispositivos móveis, por meio de aplicativos. O CRM.Net é o melhor CRM para imobiliárias e seus clientes!</p>
                ...
                <div className="row align-items-center mb-5">
                    ...
                    <div className="col-lg-7 col-sm-7 center-mob">
                      ...
                      <p>O CRM.Net é uma ótima opção para integrar a sua franquia. Com o CRM acessível, sua franquia conseguirá ter landing pages eficientes, possuir relatórios completos e atualizados, além de compreender o seu tráfego, definir sua persona e aplicar um funil de vendas.</p>
