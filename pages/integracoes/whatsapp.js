            ...
            <div className="container pb-5">
              ...
              <div className="container">
                ...
                <div className="row align-items-center pt-mob">
                    ...
                    <p>O Whatsapp em automação está liberado para poucas empresas no mundo. Somos parceiros oficiais para utilizar a API WhatsApp Business e criamos automações dentro do CRM da B2 CRM que te ajudam no seu dia a dia.</p>
                ...
                <div className="row align-items-center pt-mob">
                    ...
                    <p>A B2 CRM é um Hub de leads e de comunicação para todas as suas valiosas conversas comerciais.</p>
                ...
                <div className="row align-items-center flex-row-reverse pt-mob">
                    ...
                    <p>Assim como no app nativo do Whatsapp, com a B2 CRM você também pode enviar e receber arquivos de áudio, vídeo, PDF e imagens. Excelente para enviar suas propostas e catálogo de produtos em pdf.</p>
                    </div>
                </div>
